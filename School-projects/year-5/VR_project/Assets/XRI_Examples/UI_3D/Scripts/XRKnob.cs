...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRKnob : XRBaseInteractable
    {
        ...
        //left
        [SerializeField]
        Transform m_Handle1 = null;
        //right
        [SerializeField]
        Transform m_Handle2 = null;
        ...
        void StartGrab(SelectEnterEventArgs args)
        {
           ...
           /* if (Vector3.Distance(m_Interactor.transform.position, m_Handle1.transform.position) <
                Vector3.Distance(m_Interactor.transform.position, m_Handle2.transform.position))
            {
                if(m_Handle1 != null)
                    m_Handle = m_Handle1;
            }
