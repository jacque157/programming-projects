...
SCHEDULE_RATE = 0.5
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 13.662,
...
SCHEDULE_RATE = 0.5
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 34.944, 
...
LEARNING_RATE = 1e-3
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 9.173, 
...
LEARNING_RATE = 1e-4
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 1.491, 
...
LEARNING_RATE = 1e-4
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 1.919, 
...
LEARNING_RATE = 1e-3
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 27.175,
...
LEARNING_RATE = 5e-4
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 12.390, 
...
LEARNING_RATE = 5e-4
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 32.291, 
...
LEARNING_RATE = 1e-3
"""
# epoch: 99, loss: 0.000, absolute MPJPE: 43.731, 
...
if __name__ == '__main__':
    ...
    network = build_ResNet(layers=34, in_channels=3, n_joints=22, pretrained=True)
