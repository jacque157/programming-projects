...
class Engine:
    def __init__(self, width=1024, height=640, scene=Scene2) -> None:
        ...
        self.camera.player = self.scene.player
    ...
    def init_textures(self):
        ...
        self.textures['cat'] = Texture.Texture(self, 'objects/cat/20430_cat_diff_v1.jpg')
