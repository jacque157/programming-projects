...
from Tester import PointNetRelativePoseTester
...
MODEL_PATH = os.path.join('.', 'models', 'PointPoseNet_RelativePoseEstimation_Camera1', 'net_88.pt')
...
if __name__ == '__main__':
    ...
    model = PointNet.PointPoseNet(CHANNELS, Eyes_Japan_ts_dataset.joints - 1, device)
    model.load_state_dict(torch.load(MODEL_PATH, map_location='cuda:0'))
    model.to(device)
    tester = PointNetRelativePoseTester(model, test_dataloader,
