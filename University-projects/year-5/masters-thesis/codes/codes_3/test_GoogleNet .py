...
from Networks import GooglePoseNet
from Dataset import *
...
MODEL_PATH = os.path.join('.', 'models', 'InceptionPoseNet_RelativePoseEstimation_Camera1', 'net_65.pt')
...
if __name__ == '__main__':
    ...
    model = GooglePoseNet.GooglePoseNet(CHANNELS, Eyes_Japan_ts_dataset.joints - 1)
