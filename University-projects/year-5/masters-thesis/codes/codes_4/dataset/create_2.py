...
POINTS = 2048
FX, FY, CX, CY = 400, 400, 256, 256 # one principal point was set incorrectly the generated heat maps are wrong the trained networks had mpjpe of 40mm, maybe with correct heat maps this can be imrpoved
