...
public class Enemy : MonoBehaviour
{
    ...
    public bool WallCollision(Direction direction)
    {
        ...
        if (Physics.CheckSphere(transform.position, hitbox.radius, LayerMask.GetMask("Wall")))
        {
    ...
    {
        CapsuleCollider playersHitbox = GameObject.FindGameObjectsWithTag("Player")[0].GetComponent<CapsuleCollider>();
        CapsuleCollider spiderHitbox = GetComponent<CapsuleCollider>();
        return spiderHitbox.bounds.Intersects(playersHitbox.bounds);
    }
